<%@ taglib uri="/WEB-INF/mrald.tld" prefix="mrald"%><%@ page import="org.mitre.mrald.util.*" %><%@ page import="java.util.Enumeration" %><%
...
<html>
    <head>
        <title>Update Table <%=tableName %></title>
        <%=Config.getProperty( "CSS" ) %>
    </head>
    <body>
        <center>
            <div id="header">
                <h1 class="headerTitle"><%=Config.getProperty( "TITLE" ) %>
                <br />
                Update Table <%=tableName%></h1>
            </div>
            <script language="JavaScript1.2" type="text/javascript" src="navi.js">
            </script>
