...
win.focus();}
  ...
  <body>
      ...
      <br/><a href="javascript:NewWindow('help/step2.html','acepopup','640','480','center','front');">Help with this Form?</a>
    ...
    <a href="http://mitre.org">MITRE</a> | <a href="mailto:mrald-dev-list@lists.mitre.org">Contact Developers</a>
      ...
      <input type='hidden' name='formType' value='Label'>
      <mrald:addSection className="org.mitre.lattice.query.LabelElement" title="Set Labels">
      ...
      <mrald:addSection className="org.mitre.mrald.formbuilder.LinkElement" title="Links">
        <center><a href="javascript:NewWindow('help/step2.html#Links','acepopup','640','480','center','front');">Help with this Section?</a><BR></center>
      </mrald:addSection>
      <br><br>
      <mrald:addSection className="org.mitre.mrald.formbuilder.FieldElement" title="Available Columns">
      ...
      <br><br>
      <mrald:addSection className="org.mitre.mrald.query.FilterElement" howMany="4" title="Filters">
