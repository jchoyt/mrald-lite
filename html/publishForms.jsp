...
<html>
  ...
  <body>
    ...
    <form method="post" action="FormServer.jsp?action=publish&amp;">
     <div id="main-copy">
      <h1 id="introduction" style="border-top: none; padding-top: 0;">Publish Forms List
      </h1>
      <p>
    <br />
      <mrald:FormsList formType="All" />
     <br />
      </p>
     </div>
     <center>
