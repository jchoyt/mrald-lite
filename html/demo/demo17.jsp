...
<head>
    ...
    <script language="JavaScript1.2" type="text/javascript" src="../showSampleValue.js"></script>
...
<option value="Table:SALARIES~Field:SALARY~Order:1" selected="" >Salary</option>
</select>
...
<p class="helpBoxTitle">Tutorial - Slide 9 : General Filters (cont.)</p>
<p class="helpBoxText">Try to filter the data to show only players who have been born since 1970. To do this select 'Birth Date' from the first drop down, then '>' from the second list and input 1970 into the third box on the same row.</p>
<p class="helpBoxText">Clicking on 'Retrieve Data' button will show annual salaries for players for only the year 2004, and born since 1970.</p>
<p class="helpBoxText">The <i>General Filters</i> provide users with the most flexibility and options to 'slice and dice' the data in any desired way. As, any filter listed can be used, in combination with multiple operands, such as 'NOT IN' or 'greater than', this filter becomes a simple yet powerful tool.</p>

<center><p class="helpBoxText"><button type="button" onclick="location='demo7.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo9.jsp'"><b>Next Slide</b></button></p></center>
...
<select id="Filter2List" name="Filter2">
<option/>
...
<input name="Filter2"  id="Filter2ListValue" type="text" size="22" value="2004"/>
<img src="../images/mrald_sample.jpg" height="24" width="24" onclick="showSample('popUp2', 'Filter2List')">Display Sample</img>
<span id="popUp2"></span>
<br/>

<select id="Filter3List" name="Filter3">
<option/>
...
<input name="Filter3" id="Filter3ListValue" type="text" size="22"/>
<img src="../images/mrald_sample.jpg" height="24" width="24" onclick="showSample('popUp2', 'Filter3List')">Display Sample</img>
<br/>

<select id="Filter4List" name="Filter4">
<option/>
<option value="Table:SALARIES~Field:YEARID~Type:Numeric">Year</option>
<option value="Table:TEAMSFRANCHISES~Field:FRANCHNAME~Type:String">Team</option>
<option value="Table:TEAMS~Field:PARK~Type:String">Park</option>
...
<img src="../images/mrald_sample.jpg" height="24" width="24" onclick="showSample('popUp2', 'Filter4List')">Display Sample</img>
<br/>
</div>
