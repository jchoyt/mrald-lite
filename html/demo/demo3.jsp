...
<p class="helpBoxTitle">Tutorial - Slide 4 : Sort Criteria </p>
<p class="helpBoxText">The <i>Sort Criteria</i> section allows the user to specify exactly how the data is ordered</p>
<p class="helpBoxText">In this case the data is to be sorted by the Salary amount in descending order. </p>
<p class="helpBoxText">Clicking the <i>Retrieve Data</i> button will display name, team, year and salary data for highest salaried players.</p>
<p class="helpBoxText">Multiple Sort Criteria can be specified at the same time.</p>

<center><p class="helpBoxText"><button type="button" onclick="location='demo2.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo4.jsp'"><b>Next Slide</b></button></p></center>
