...
<p class="helpBoxTitle">Tutorial - Slide 15 : Formats</p>
<p class="helpBoxText">The data can be displayed in variety of formats. All the examples so far have used the <i>HTML</i> format. </p>
<p class="helpBoxText">The <i>HTML with Links</i> is a more complex output. The system automatically 'looks' for links in the data, and generates links in the output. These links allow for users to view data in other tables that reference the original data.</p>
<p class="helpBoxText">To see an example of this functionality, select the <i>HTML with Links</i> option. The Team ID data is linked to other data. Clicking on this data will display related data in .....</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo13.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo15.jsp'"><b>Next Slide</b></button></p></center>
