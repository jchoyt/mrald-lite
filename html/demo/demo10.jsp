...
<p class="helpBoxTitle">Tutorial - Slide 11 : Statistical Functions (cont.)</p>
<p class="helpBoxText">Now select 'Year', from the 2nd Group By option labelled 'Then By', and click on Retrieve Data. </p>
<p class="helpBoxText">You will now see that the salary data is a summation of salaries paid out for each team grouped by each year. </p>
<p class="helpBoxText">The Filter functionality can be used along with the Statistical functions. In this case, clicking the 'Salary greater than $10 million' checkbox, will provide different results, as, in this case, only the salaries for players earning more than $10 million annually will be used in the calculations.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo9.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo11.jsp'"><b>Next Slide</b></button></p></center>
