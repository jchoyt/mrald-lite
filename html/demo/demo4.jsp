...
<p class="helpBoxTitle">Tutorial - Slide 5 : Filters </p>
<p class="helpBoxText">The most important function of the Forms, is to allow users to specify exactly how they want to filter the data.</p>
<p class="helpBoxText">This allows for the user to see the data that is most personally relevant.</p>
<p class="helpBoxText">Mutiple types of Filters can be specified in MRALD. Here we see three types of Filters</p>
<p class="helpBoxText"><li>A Drop Down Filter</li></p><p class="helpBoxText"><li>A Checkbox filter</li><li>A General Filter</li></p>
<p class="helpBoxText">In this case the data is currently being filtered on salaries greater than $10 million. The use of each will be coverd in turn.</p>
<p class="helpBoxText">All the Filters are specified when using the MRALD FormBuilder functionality, a discussion of which is outside the scope of this tutorial. </p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo3.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo5.jsp'"><b>Next Slide</b></button></p></center>
