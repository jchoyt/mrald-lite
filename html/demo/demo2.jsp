...
<p class="helpBoxTitle">Tutorial - Slide 3 : Output Selection </p>
<p class="helpBoxText">The Output Selection allows the users to specify exactly which data they wish to view.</p>
<p class="helpBoxText">At the moment only Team, First Name, Last Name and Salary of the player is selected. Clicking the Retrieve Data button will display this data</p>
<p class="helpBoxText">However the user may wish to know which year the salary was given. And so selecting the <i>year</i> checkbox, will automatically include this data in the output.</p>
<p class="helpBoxText">Select this check box and press the Retrieve Data button, and you will now see that the year data is included in the output.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo1.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo3.jsp'"><b>Next Slide</b></button></p></center>
</div>
