...
<input name="Select1" type="checkbox" value="Table:SALARIES~Field:YEARID~Order:1" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" checked="">Year</input>
<br/>
...
<p class="helpBoxTitle">Tutorial - Slide 8 : General Filters</p>
<p class="helpBoxText">General Filters are provided with every Form that is built.</p>
<p class="helpBoxText">Click on the first drop down under the <i>General Filters</i> section. A list of ways to filter the data is displayed.</p>
<p class="helpBoxText">In this case the 'Year' value is selected from the list. From next drop down, on the same row, the '=' value is selected and '2004' is input into the third box on the same row</p>
<p class="helpBoxText">Clicking on 'Retrieve Data' button will show annual salaries for players for only the year 2004.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo6.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo8.jsp'"><b>Next Slide</b></button></p></center>
