...
<p class="helpBoxTitle">Tutorial - Slide 16 : Formats (cont.)</p>
<p class="helpBoxText">The <i>CSV</i> format displays, in a browser, data in Comma Separated Value text format. </p>
<p class="helpBoxText">The <i>Text</i> format displays data, in a browser, in tab delimited text format. </p>
<p class="helpBoxText">The <i>XML</i> format displays data, in a browser, in a simple XML Format. </p>
<p class="helpBoxText">Examples of each of these can be viewed in turn by selecting and retrieving data.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo14.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo16.jsp'"><b>Next Slide</b></button></p></center>
