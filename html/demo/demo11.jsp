...
<p class="helpBoxTitle">Tutorial - Slide 12 : Output Formatting Options</p>
<p class="helpBoxText">The Forms work by turning the various options into a SQL query that is then used to return data from a database</p>
<p class="helpBoxText">The <i>Query</i> option allows for Users to specify if they want the SQL Query that is produced to be displayed at the bottom of the page.</p>
<p class="helpBoxText">Press the Retrieve Data button and scroll to the bottom of the results, and you will see an SQL statement. This can sometimes help with diagnosing why expected results are not being displayed.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo10.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo12.jsp'"><b>Next Slide</b></button></p></center>
