...
<p class="helpBoxTitle">Tutorial - Slide 14 : Output Size Limit</p>
<p class="helpBoxText">The <i>Output Limit Size</i> option allows for only a certain amount of data to be initially returned to the user. This is important for the case where a large dataset could be returned, intentionally or by accident, that may take a long time to display.</p>
<p class="helpBoxText">With the <i>none</i> option selected, click on the Retrieve Data button and more than 800 rows will be displayed.  </p>
<p class="helpBoxText">Now select the <i>Lines</i> option and input 100 into the associated box. This time only the first 100 rows of data are displayed on pressing the 'Retrieve Data' option.</p>
<p class="helpBoxText">Now select the <i>Size</i> option (labeled 'MB') and input 0.03 into the associated box. This time only the about first 300 rows of data, or 0.03 MB of data, are displayed on pressing the 'Retrieve Data' option.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo12.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo14.jsp'"><b>Next Slide</b></button></p></center>
