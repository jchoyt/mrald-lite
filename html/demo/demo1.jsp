...
<span class="doNotDisplay">Navigation:</span>
    ...
    <a href="http://mitre.org">MITRE</a> | <a href="mailto:mrald-dev-list@lists.mitre.org">Contact Developers</a>
     ...
     <form method="POST" action="<%=Config.getProperty("BaseUrl")%>/FormSubmit" enctype="x-www-form-urlencoded">
...
<br/>
<input name="Select3" type="checkbox" value="Table:TEAMS~Field:PARK~Order:47" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" checked="">Park</input>
<br/>
...
<br/>
<input name="Select6" type="checkbox" value="Table:PLAYERS~Field:NAMENICK~Order:58" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" checked="">Nick Name</input>
<br/>
...
<p class="helpBoxTitle">Tutorial - Slide 2 </p>
<p class="helpBoxText">The Form shown here is an <i>Advanced Form</i></p>
<p class="helpBoxText">The Advanced Form version accesses exactly the same underlying data as the previous form, but gives the user more flexibility over what and how this data is displayed. </p>
<p class="helpBoxText">Over the next few slides, we will explain in detail each section of the Advanced Form, and how the data displayed is affected. </p>
<p class="helpBoxText">The first section that we will look at is the <i>Include in Output</i> section shown on the left.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo1-simple.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo2.jsp'"><b>Next Slide</b></button></p></center>
 </div>
