...
<p class="helpBoxTitle">Tutorial - Slide 7 : Checkbox Filters</p>
<p class="helpBoxText">A Checkbox Filter will automatically filter on a pre-defined value. For example Checking the <i>$10,000,000</i> value will return only data for players with salaries greater than $10 million.</p>
<p class="helpBoxText">The 'Others' input boxes are provided for the case if you wish to filter on another value that does not have a checkbox. </p>
<p class="helpBoxText">For example to return only data for players with an annual salary greater than $20M, uncheck the $10M checkbox, enter '20000000' or, since this database allows it '20e6', into one of the boxes labelled 'Others' and click on 'Retrieve Data'.  Leaving the $10M box checked would have retured all players with salaries greater than $10M <i>or</i> $20M.</p>
<p class="helpBoxText">'Greater than' is only one of many differnt operators possible on this kind of filter.  Other examples include equals, not equals, null, not null, and in (which allows the user to enter a list as they would in a database query).

<center><p class="helpBoxText"><button type="button" onclick="location='demo5.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo7.jsp'"><b>Next Slide</b></button></p></center>
