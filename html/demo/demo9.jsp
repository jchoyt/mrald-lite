...
<br/>
<input name="Select2" type="checkbox" value="Table:TEAMSFRANCHISES~Field:FRANCHNAME~Order:46" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" >Team</input>
<br/>
...
<br/>
<input name="Select4" type="checkbox" value="Table:PLAYERS~Field:NAMEFIRST~Order:56" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}">First Name</input>
<br/>
<input name="Select5" type="checkbox" value="Table:PLAYERS~Field:NAMELAST~Order:57" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" >Last Name</input>
<br/>
...
<br/>
<input name="Select8" type="checkbox" value="Table:SALARIES~Field:SALARY~Order:60" onMouseOver="if (EnableStats.value == 1) {}" onFocus="if (EnableStats.value == 1) {this.click(), this.blur()}" onDblClick="if (EnableStats.value == 1) {this.click(), this.blur()}" >Salary</input>
<br/>
<br/>
...
<input name="Sort1" type="checkbox" value="OrderType:DESC" checked=""/>Desc<br/>
      then by
      <select name="Sort2">
<option/>
...
<p class="helpBoxTitle">Tutorial - Slide 10 : Statistical Functions</p>
<p class="helpBoxText">Statistical Functions provide the user with the chance to analyze the data using simple database functions.</p>
<p class="helpBoxText">The form shows that the 'Sum' function has been selected. The next list only displays values for which these functions are applicable. i.e numeric or date values.</p>
<p class="helpBoxText">The value to be summed over is salary. The next option, is a <i>Group By</i> function.  In this case Group By 'Team' is selected.</p>
<p class="helpBoxText">Click on the 'Retrieve Data' button and this will show the total salaries for each team, over all years.</p>
<center><p class="helpBoxText"><button type="button" onclick="location='demo8.jsp'"><b>Previous Slide</b></button><button type="button" onclick="location='demo10.jsp'"><b>Next Slide</b></button></p></center>
...
<input type="checkbox" name="Filter1" value="Value:1000000"/>$1,000,000
        ...
        <input type="checkbox" name="Filter1" value="Value: 2500000"/> $2,500,000
          <img alt="" src="<%=Config.getProperty("BaseUrl")%>/images/spacer.gif" width="10" height="1"/>
			<input type="checkbox" name="Filter1" value="Value: 10000000"/> $10,000,000
			<img alt="" src="<%=Config.getProperty("BaseUrl")%>/images/spacer.gif" width="10" height="1"/>
        <br/>
...
<option value="Function:Sum~Order:1" selected="">
            Sum
          </option>
...
<option value="Table:SALARIES~Field:SALARY~Order:1~Type:Numeric" selected="">Salary</option>
</select>
<br/>
...
<option value="Table:TEAMSFRANCHISES~Field:FRANCHNAME~Order:4" selected="">Team</option>
