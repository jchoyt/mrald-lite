...
public class FieldUpdateElement extends ParserElement implements FormBuilderElement
{
    ...
    public String getFBHtml( DBMetaData md, int num , int thread)
    {
        ...
        String CHECK_ALL_ROW = "\n<tr><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Filter" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table:<:tableName:>');} else{CheckAll('Filter:true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Stat:true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');} else{CheckAll('Stat" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Group:true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');} else{CheckAll('Group:true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');}\" checked></th><th>&nbsp;</th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');} else{CheckAll('Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>');}\" checked></th><th>&nbsp;</th></tr>";
        String FIELD_ROW = "\n<tr><td><:tableName:></td><td><input type=\"hidden\" name=\"FBUpdate<:orderNo:>\" value=\"Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>~Field" + FormTags.NAMEVALUE_TOKEN_STR + "<:column_name:>~Type:<:type:>\"><:column_name:></td><td><input name=\"FBUpdate<:orderNo:>\" type=\"text\" size=\"15\" value=\"<:nice_column_name:>\"></td><td><input type=checkbox \"<:checkedVal:>\" name=\"FBUpdate<:orderNo:>\" value=\"PrimaryKey" + FormTags.NAMEVALUE_TOKEN_STR + "<:PrimaryKey:>\"></td><td align=\"left\"><:listColumn:></td><td align=\"center\"><input name=\"FBUpdate<:orderNo:>\" value=\"Filter" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"FBUpdate<:orderNo:>\" value=\"Stat:true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"checkbox\" <:stat checked:>></td><td align=\"center\"><input name=\"FBUpdate<:orderNo:>\" value=\"Group" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"FBUpdate<:orderNo:>\" type=\"text\" size=\"3\" value=\"<:orderNo:>\"></td><td align=\"center\"><input name=\"FBUpdate<:orderNo:>\" value=\"Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"checkbox\" checked></td><td><:formatChoices:></td><input name=\"FBUpdate<:orderNo:>\" value=\"Output" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"hidden\"><input name=\"FBUpdate<:orderNo:>\" value=\"Default" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<:tableName:>\" type=\"hidden\"></tr>";
