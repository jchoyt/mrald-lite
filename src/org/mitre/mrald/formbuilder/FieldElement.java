...
public class FieldElement extends ParserElement implements FormBuilderElement
{
	...
	public String getFBHtml(DBMetaData md, int num, int thread)
	{
		...
		String CHECK_ALL_ROW = "\n<th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Ignore" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Ignore" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\"></th><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Output" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Output" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Default" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Default" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Filter" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Filter" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Stat" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Stat" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Group" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Group" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th>&nbsp;</th><th><input type=checkbox onclick=\"if(this.checked==false){ClearAll('Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');} else{CheckAll('Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">');}\" checked></th><th>&nbsp;</th><th>&nbsp;</th></tr>";
		String FIELD_ROW = "\n<tr><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Ignore" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\"></td><td><" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + "></td><td><input type=\"hidden\" name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"DBName" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "db_name" + FormTags.NAMEVALUE_TOKEN_STR + ">~Schema" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "db_schema" + FormTags.NAMEVALUE_TOKEN_STR + ">~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">~Field" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "column_name" + FormTags.NAMEVALUE_TOKEN_STR + ">~Type" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "type" + FormTags.NAMEVALUE_TOKEN_STR + ">\"><" + FormTags.NAMEVALUE_TOKEN_STR + "column_name" + FormTags.NAMEVALUE_TOKEN_STR + "></td><td><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"text\" size=\"15\" value=\"<" + FormTags.NAMEVALUE_TOKEN_STR + "nice_column_name" + FormTags.NAMEVALUE_TOKEN_STR + ">\"></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Output" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Default" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Filter" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Stat" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" <" + FormTags.NAMEVALUE_TOKEN_STR + "stat checked" + FormTags.NAMEVALUE_TOKEN_STR + ">></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Group" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" checked></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"text\" size=\"3\" value=\"<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\"></td><td align=\"center\"><input name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"Sort" + FormTags.NAMEVALUE_TOKEN_STR + "true~Table" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "tableName" + FormTags.NAMEVALUE_TOKEN_STR + ">\" type=\"checkbox\" checked></td><td><" + FormTags.NAMEVALUE_TOKEN_STR + "formatChoices" + FormTags.NAMEVALUE_TOKEN_STR + "></td><td align=\"left\"><" + FormTags.NAMEVALUE_TOKEN_STR + "comments" + FormTags.NAMEVALUE_TOKEN_STR + "></td></tr>\n<input type=\"hidden\" name=\"Field<" + FormTags.NAMEVALUE_TOKEN_STR + "orderNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\" value=\"SqlThread" + FormTags.NAMEVALUE_TOKEN_STR + "<" + FormTags.NAMEVALUE_TOKEN_STR + "threadNo" + FormTags.NAMEVALUE_TOKEN_STR + ">\"/>\n";
