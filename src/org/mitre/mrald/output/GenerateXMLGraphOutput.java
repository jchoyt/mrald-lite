 ...
 */
public class GenerateXMLGraphOutput extends GenerateXML
...
//    private final static int rowsIndent = 0;
     ...
     *@since
     */
    public GenerateXMLGraphOutput( PrintWriter oOutputStream )
     ...
     *@since
     */
    public GenerateXMLGraphOutput( PrintWriter oOutputStream, int lineLimit, float mbLimit, XMLOutput passedXmlOutput )
        throws GenerateXMLException
    {
        super( oOutputStream );
