 ...
 * List all tables for multiDb. Multiple databases.
 *@author     ghamilton
 *@created    August 21st, 2007
 */
public class AllTablesMultiDbListTag extends TagSupport
{
    String schema;
     ...
     */
    public AllTablesMultiDbListTag() { }
...
//        String[] types = {"TABLE", "VIEW"};
        ...
        for ( int i = 0; i < tableList.size(); i++ )
        {
            ...
            buffer.append( "<input type='" + inputType + "' name='" + FormTags.TABLE_TAG + "' value='" + datasource + "." + tableName + "'></td>" );
            if ( displayTables.equals( "true" ) )
            {
